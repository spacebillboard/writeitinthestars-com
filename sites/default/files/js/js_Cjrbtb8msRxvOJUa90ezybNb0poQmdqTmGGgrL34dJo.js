...
(function($, Drupal){
  ...
  Drupal.behaviors.bootstrapAnchors = {
    ...
    bootstrapAnchor: function (element) {
      // MDC: added the last check myself (otherwise this would break the Bootstrap carousel...)
      element.validAnchor = element.nodeName === 'A' && (location.hostname === element.hostname || !element.hostname) && element.hash.replace(/#/,'').length && (' ' + element.className + ' ').indexOf(' carousel-control ') == -1;;
